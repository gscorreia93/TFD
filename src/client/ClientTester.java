...
public class ClientTester extends Thread{
	...
	protected ClientTester(String clientID, ClientLibrary cl, int messageNumber, int timeBetweenRequests, int checkpoint, int numberOfThreads){
	...
	private synchronized String randomCommandGenerator() {
